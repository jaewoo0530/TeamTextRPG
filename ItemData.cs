    ...
    internal class ItemData
    {
        ...
        public ItemData()
        {
            items = new List<Item>
            {
                ...
                new Item("낡은 지팡이", ItemType.무기, 8, "쉽게 볼 수 있는 낡은 지팡이 입니다.", false, true),
                new Item("낡은 활", ItemType.무기, 2, "쉽게 볼 수 있는 낡은 지팡이 입니다.", false, true),

                new Item("강철 검", ItemType.무기, 8, "쉽게 볼 수 있는 낡은 검 입니다.", false, false),
                new Item("고목 지팡이", ItemType.무기, 12, "쉽게 볼 수 있는 낡은 지팡이 입니다.", false, false),
                new Item("은의 활", ItemType.무기, 4, "쉽게 볼 수 있는 낡은 지팡이 입니다.", false, false)
            };
